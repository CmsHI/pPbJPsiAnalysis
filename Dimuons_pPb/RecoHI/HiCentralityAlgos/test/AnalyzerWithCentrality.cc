...
// $Id: AnalyzerWithCentrality.cc,v 1.14 2011/03/24 21:49:12 yilmaz Exp $
//
//
...
//  bool debugEvents_ = iConfig.getUntrackedParameter<bool>("debugEvents",false);
  	tableDump_ = iConfig.getUntrackedParameter<bool>("dumpTable",true);
  	debugEvents_ = iConfig.getUntrackedParameter<bool>("debugEvents",false);
