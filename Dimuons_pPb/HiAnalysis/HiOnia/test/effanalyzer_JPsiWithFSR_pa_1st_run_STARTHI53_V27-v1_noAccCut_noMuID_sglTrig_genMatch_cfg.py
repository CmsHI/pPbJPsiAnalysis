...
options.outputFile = "JPsiWithFSR_pa_1st_run_STARTHI53_V27-v1_noAccCut_noMuID_sglTrig_genMatch-v1.root"
...
process.hionia = cms.EDAnalyzer('MyEffAnalyzer_noAccCut_noMuID_sglTrig_genMatch',
...
#                                genParticles = cms.InputTag("hiGenParticles"), #KYO - embedded
                                ...
                                isPromptMC = cms.untracked.bool(True), #PR or NP KYO
