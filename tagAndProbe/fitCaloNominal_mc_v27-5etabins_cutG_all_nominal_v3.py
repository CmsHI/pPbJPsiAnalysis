...
process.TnP_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer", 
    ## Input, output 
                                     InputFileNames = cms.vstring("file:/home/kilee/CMSSW_5_3_20/UserCode/skim/MC/tnpTree_mc_allDirection_weightAdded_v27.root"),
                                     OutputFileName = cms.string("../ResultsFit/outputEveryCut_mc_allDirection_v27_nominalCond_5etaBins_cutG_all_nominal_v3.root"),
	...
	PADoubleMuOpen = cms.vstring("PADoubleMuOpen", "dummy[pass=1,fail=0]"),
        ...
        ptBin_eta1_0 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass","vtxWeight"),               # for mc
        ...
        cbGaussPlusExpo1_0 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[10.0, 0.5, 30.], n[2, 0.5, 20.0])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[5,-20000.0,20000.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo1_1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[1.0, 0.5, 100.], n[2, 0.5, 100.0])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
        ...
        cbGaussPlusExpo2_0 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.5, 0.0, 100.0], n[2.0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo2_1 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.1, 0.0, 100.0], n[2.0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-1000.,1000.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        ...
        cbGaussPlusExpo2_4 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[1.0, 0.0, 100.0], n[2.0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo2_5 = cms.vstring(
            ...
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[-0.5,-0.5,0.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo2_6 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.5, 0.5, 40.0], n[2.0, 0.5, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-20.0,20.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo3_0 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[1.0, 0.0, 100.0], n[1.0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-5.0,5.0])",
        ...
        cbGaussPlusExpo3_4 = cms.vstring(
            ...
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[-1,-1.0,0.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        ...
        cbGaussPlusExpo3_6 = cms.vstring(
            ...
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-50.0,50.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        ...
        cbGaussPlusExpo3_8 = cms.vstring(
            ...
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[2,1.0,2.5])",
            "Exponential::backgroundFail(mass, lf[0-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo3_9 = cms.vstring(
            ...
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[-5,-8.0,-1.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo4_0 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[10., 0.0, 30.0], n[2, 0.0, 3.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo4_3 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[30.0, 0.0, 100.0], n[0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo4_4 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[20.0, 0.0, 50.0], n[0, 0.0, 200.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo4_5 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.5, 0.0, 100.0], n[2, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[1,1.0,3.5])",
            "Exponential::backgroundFail(mass, lf[0,-0.5,0.5])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        cbGaussPlusExpo4_6 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.5, 0.5, 10.0], n[2, 0.1, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo4_8 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[1.0, 0.0, 100.0], n[2, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-50.0,50.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo4_9 = cms.vstring(
            ...
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[-5,-6.0,0.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
        ...
        cbGaussPlusExpo5_0 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[20.0, 0.0, 100.0], n[50, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo5_3 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[20.0, 0.0, 50.0], n[0, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo5_4 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[10.0, 0.0, 50.0], n[50, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.04,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-10.0,10.0])",
        ...
        cbGaussPlusExpo5_6 = cms.vstring(
            "CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma1[0.01,0.01,0.1], alpha[0.1, 0.0, 100.0], n[2, 0.0, 100.])",
            "Gaussian::signal2(mass, mean[3.1, 3.0, 3.2], sigma2[0.01,0.01,0.1])",
            "SUM::signal(signal1,vFrac[0.8,0,1]*signal2)",
            "Exponential::backgroundPass(mass, lp[0,-10.0,10.0])",
            "Exponential::backgroundFail(mass, lf[0,-100.0,100.0])",
            "efficiency[0.9,0,1]",
            "signalFractionInPassing[0.9]"
            ),
