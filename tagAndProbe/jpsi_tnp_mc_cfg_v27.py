...
if   "CMSSW_5_3_" in os.environ['CMSSW_VERSION']:
    ...
    process.source.fileNames = [
        ...
        'file:/u/user/kilee/CMSSW_5_3_20_pPbJpsiTnP/Usercode/36E1CD6A-3A16-E511-82CC-002590747E0E.root', #new MC sample
        #'file:PromptJpsi_PYTHIAboosted_2nd_RECO_STARTHI53_V27_v2_100_1_aoF.root', #old MC sample
    ]
