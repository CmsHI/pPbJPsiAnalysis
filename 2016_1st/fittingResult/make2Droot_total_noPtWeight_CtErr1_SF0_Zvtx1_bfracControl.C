...
/////// main func. ///////
int make2Droot_total_noPtWeight_CtErr1_SF0_Zvtx1_bfracControl(char *dirName = "8rap9pt", char *dateName = "no"){
  ...
  using namespace std;
	...
	// *** without pt weight
	TFile *fEffPRPbp = new TFile(Form("../Efficiency/EffAna_%s_PRMCpythia_Pbp_CtErr1_SF0_Zvtx1.root",dirName));
	TFile *fEffPRpPb = new TFile(Form("../Efficiency/EffAna_%s_PRMCpythia_pPb_CtErr1_SF0_Zvtx1.root",dirName));
	TFile *fEffNPPbp = new TFile(Form("../Efficiency/EffAna_%s_NPMCpythia_Pbp_CtErr1_SF0_Zvtx1.root",dirName));
	TFile *fEffNPpPb = new TFile(Form("../Efficiency/EffAna_%s_NPMCpythia_pPb_CtErr1_SF0_Zvtx1.root",dirName));
	...
	////////////////////////////////////////////////
	////// save as a root file
	TFile *outFile = new TFile(Form("total2Dhist_%s_noPtWeight_CtErr1_SF0_Zvtx1_bfracControl.root",dirName),"RECREATE");
	std::cout << "dirName: " << dirName << std::endl;
	cout << "total2Dhist_"<<dirName<<"_noPtWeight_CtErr1_SF0_Zvtx1_bfracControl.root has been created :) " <<endl;	
