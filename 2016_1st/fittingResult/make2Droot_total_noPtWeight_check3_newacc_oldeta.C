...
/////// main func. ///////
int make2Droot_total_noPtWeight_check3_newacc_oldeta(char *dirName = "8rap3pt", char *dateName = "no"){
  ...
  using namespace std;
	...
	// *** without pt weight
	TFile *fEffPRPbp = new TFile(Form("../Efficiency/EffAna_%s_PRMCpythia_Pbp_CtErr1_SF1_Zvtx1_check3_newacc_oldeta.root",dirName));
	TFile *fEffPRpPb = new TFile(Form("../Efficiency/EffAna_%s_PRMCpythia_pPb_CtErr1_SF1_Zvtx1_check3_newacc_oldeta.root",dirName));
	TFile *fEffNPPbp = new TFile(Form("../Efficiency/EffAna_%s_NPMCpythia_Pbp_CtErr1_SF1_Zvtx1_check3_newacc_oldeta.root",dirName));
	TFile *fEffNPpPb = new TFile(Form("../Efficiency/EffAna_%s_NPMCpythia_pPb_CtErr1_SF1_Zvtx1_check3_newacc_oldeta.root",dirName));
	...
	////////////////////////////////////////////////
	////// save as a root file
	TFile *outFile = new TFile(Form("total2Dhist_%s_noPtWeight_check3_newacc_oldeta.root",dirName),"RECREATE");
	std::cout << "dirName: " << dirName << std::endl;
	cout << "total2Dhist_"<<dirName<<"_noPtWeight_check3_newacc_oldeta.root has been created :) " <<endl;	
