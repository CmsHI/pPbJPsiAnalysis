...
/////// main func. ///////
int make2Droot_total_noPtWeight_check5_oldacc_oldeta_private_lowerptlimit(char *dirName = "8rap3pt", char *dateName = "no"){
  ...
  using namespace std;
	...
	////////////////////////////////////////////////
	////// save as a root file
	TFile *outFile = new TFile(Form("total2Dhist_%s_noPtWeight_check5_oldacc_oldeta_private_lowerptlimit.root",dirName),"RECREATE");
	std::cout << "dirName: " << dirName << std::endl;
	cout << "total2Dhist_"<<dirName<<"_noPtWeight_check5_oldacc_oldeta_private_lowerptlimit.root has been created :) " <<endl;	
