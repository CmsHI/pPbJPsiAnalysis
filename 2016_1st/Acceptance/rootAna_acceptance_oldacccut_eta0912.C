...
// MrapNpt : (89, 83, 63, 62)
void rootAna_acceptance_oldacccut_eta0912(int mrapnpt=83, bool isPrompt=true){
  ...
  Double_t rapBinsArr6rap[7] = {-2.4, -1.97, -1.37, -0.47, 0.43, 1.03, 1.46};
	...
	////////////////////////////////////////////////////////////////////////////
	// Save the data!
	TFile *outFile = new TFile(Form("AccAna_%s_oldacccut_eta0912.root",strName),"RECREATE");
	std::cout << "strName: " << strName << std::endl;
	outFile->cd();
