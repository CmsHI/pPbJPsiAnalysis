...
void draw_2D_acc(bool isPrompt = true, bool is8rap9pt = true)
{
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->SaveAs(Form("dir_2D_acc/h2D_Den_isPrompt%d.pdf",(int)isPrompt));
	...
	c1->Modified();
	c1->Update();
	c1->SaveAs(Form("dir_2D_acc/h2D_Num_isPrompt%d.pdf",(int)isPrompt));
*/
	...
	c1->SaveAs(Form("dir_2D_acc/h2D_Acc_%s.pdf",sampleName));
