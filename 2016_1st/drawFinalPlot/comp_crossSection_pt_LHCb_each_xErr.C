...
//	}
	...
	c_pr->Update();
	c_pr->SaveAs(Form("comparisonLHCb/comp_crossSection_pt_LHCb_pr_isLog%d_isPtCut_%d_shifted_%d_each_xErr.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_pr->SaveAs(Form("comparisonLHCb/comp_crossSection_pt_LHCb_pr_isLog%d_isPtCut_%d_shifted_%d_each_xErr.png",(int)isLog,(int)isPtCut,(int)shifted));
	legUR->Clear();
	//c_pr->Clear();
	...
	c_np->Update();
	c_np->SaveAs(Form("comparisonLHCb/comp_crossSection_pt_LHCb_np_isLog%d_isPtCut_%d_shifted_%d_each_xErr.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_np->SaveAs(Form("comparisonLHCb/comp_crossSection_pt_LHCb_np_isLog%d_isPtCut_%d_shifted_%d_each_xErr.png",(int)isLog,(int)isPtCut,(int)shifted));
	//legUR->Clear();
	//c_np->Clear();
