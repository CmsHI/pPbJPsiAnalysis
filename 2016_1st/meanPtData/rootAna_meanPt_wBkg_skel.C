...
int cndr_rootAna_meanPt_wBkg__ycmnum_(char *strBin = "PAS"){
	...
	TFile *fDatapPb;
	// PAS (old)
	fDataPbp1 = new TFile("/home/songkyo/kyo/pPbDataSample/Data_old/merged_pPbData_1st_ntuple_PromptReco-v1_GR_P_V43D_pileupRej_muID_tot.root");
	fDataPbp2 = new TFile("/home/songkyo/kyo/pPbDataSample/Data_old/merged_pPbData_1st_ntuple_ReprocessedReco-v1_GR_P_V43F_pileupRej_muID_tot.root");
	fDatapPb = new TFile("/home/songkyo/kyo/pPbDataSample/Data_old/merged_pPbData_2nd_ntuple_PromptReco-v1_GR_P_V43D_pileupRej_muID_tot.root");
	// 8rap9pt (new)
	/*
...
*/
	...
	Double_t yArr[nRapTmp] = {_ycmup_, _ycmdown_};
...
*/
			...
			cmulti[in][ir]->Update();
			cmulti[in][ir]->SaveAs(Form("dir_meanPt_n%d_%s/meanPt_%s_%d_%d_wBkg__ycmnum_.pdf",nbin,strBin,strBin,in,ir));
			//cmulti[in][ir]->Clear();
		}
	}
	
	/// Save as a root file
	TFile *outFile = new TFile(Form("dir_meanPt_n%d_%s/meanPt_%s_wBkg__ycmnum_.root",nbin,strBin,strBin),"RECREATE");
