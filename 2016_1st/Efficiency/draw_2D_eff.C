...
void draw_2D_eff(bool isPrompt = false, bool is8rap9pt = true)
{
	...
	f2D = new TFile(Form("./EffAna_%s_%spythia_Pbp_CtErr1_SF1_Zvtx1.root",strBin,strPrompt));
...
*/
	...
	c1->SaveAs(Form("dir_2D_eff/h2D_Eff_%s.pdf",sampleName));
