...
//=========  (Tue Jul 21 12:15:03 2015) by ROOT version6.02/08
   ...
   //TH2F *hr15 = new TH2F("hr15","",10,0,20,20,0.7,1.1);
   hr15->SetStats(0);
...
//   leg = new TLegend(0.5,0.15,0.82,0.4,NULL,"brNDC");
   leg->SetBorderSize(0);
...
*/
	...
	///////// from Ramona
	const int nBin = 2;
	Double_t eps09NLO_px[nBin] = {7.95946, 13.31027};
	Double_t eps09NLO_py[nBin] = {9.5308E-01, 9.4434E-01};
	...
	Double_t eps09NLO_eylow_tmp[nBin] = {9.2059E-01, 9.1307E-01};
	Double_t eps09NLO_eyhigh_tmp[nBin] = {1.0079E+00, 9.7488E-01};   
...
//	gRFB_pr_sys_1->SetFillColor(kRed-9);
	gRFB_pr_sys_1->SetFillColor(kGray);
	gRFB_pr_sys_1->Draw("2");
	//SetGraphStyle(gRFB_pr_1,1,3);
	SetGraphStyle(gRFB_pr_1,9,0);
	gRFB_pr_1->Draw("P");
	
	w6->SaveAs("two_rfb_pt_y120.pdf");
