...
void draw_1D_RFB_pt_bhong(char* dirName = "8rap9pt2gev", int runCode=0, bool isZoomIn = true, bool isPrompt=false)
{
...
*/	
  ...
  Double_t ex[ntmp] = {0.,0.,0.};
	...
	// --- read-in file
	//TFile * f2D = new TFile("../FittingResult/totalHist_pA_8rap9pt_newcut_nominal_Zvtx1_SF1_noPtWeight.root");
	TFile * f2D = new TFile("../FittingResult/totalHist_pA_8rap9pt_newcut_nominal_Zvtx1_SF1_noPtWeight_releasePRResW.root");
	//TFile * f2D = new TFile("../FittingResult/totalHist_pA_8rap9pt_oldcut_nominal_Zvtx1_SF1_noPtWeight.root");
	
	//TFile * f2D = new TFile("../FittingResult/totalHist_pA_8rap9pt_oldcut_nominal_Zvtx1_SF1_noPtWeight_privFit_privMC.root");
...
/*
	...
	for (Int_t iy = 0; iy < nbinsX; iy++) {
		// --- merging
		if (runCode ==0) {	
			h1D_CorrY_tot[iy] = (TH1D*)h1D_CorrY[iy]->Clone(Form("h1D_CorrY_tot_%d",iy));
