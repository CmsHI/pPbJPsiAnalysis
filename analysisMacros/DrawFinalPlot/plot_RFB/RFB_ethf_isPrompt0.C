void RFB_ethf_isPrompt0()
{
//=========Macro generated from canvas: c1/c1
//=========  (Wed Jul 20 17:49:17 2016) by ROOT version6.04/02
   ...
   Graph_gRFB_sys_13002->SetMinimum(0.6892812);
   Graph_gRFB_sys_13002->SetMaximum(1.000086);
   ...
   Graph_gRFB_sys_23003->SetMinimum(0.7434696);
   Graph_gRFB_sys_23003->SetMaximum(0.9811503);
   ...
   Graph_gRFB_sys_33004->SetMinimum(0.6763872);
   Graph_gRFB_sys_33004->SetMaximum(1.041588);
   ...
   Graph_gRFB_03005->SetMinimum(0.5608535);
   Graph_gRFB_03005->SetMaximum(0.9645183);
   ...
   Graph_gRFB_13006->SetMinimum(0.6610749);
   Graph_gRFB_13006->SetMaximum(1.058035);
   ...
   Graph_gRFB_23007->SetMinimum(0.7235045);
   Graph_gRFB_23007->SetMaximum(1.004411);
   ...
   Graph_gRFB_33008->SetMinimum(0.6752584);
   Graph_gRFB_33008->SetMaximum(1.038039);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   TLatex *   tex = new TLatex(0.88,0.84,"Non-prompt J/#psi");
tex->SetNDC();
   tex->SetTextAlign(32);
   tex->SetTextFont(42);
