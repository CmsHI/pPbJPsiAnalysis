//void nc_totalComp()
{
  ...
  TFile* f01 = TFile::Open("EffAna_8rap9pt_Pbp_PR_oldcut_Zvtx1_SF1_privtest.root");
  TFile* f02 = TFile::Open("EffAna_8rap9pt_Pbp_PR_oldcut_Zvtx1_SF1_privtest_zcut.root");
