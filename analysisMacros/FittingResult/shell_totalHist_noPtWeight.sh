...
root -l -b -q 'make_totalHist_pp_noPtWeight_releasesigmaPRResW.C+(89,2,false,true,"nominal")'
...
root -l -b -q 'make_totalHist_pA_noPtWeight_releasesigmaPRResW.C+(89,2,true,true,"nominal")'
