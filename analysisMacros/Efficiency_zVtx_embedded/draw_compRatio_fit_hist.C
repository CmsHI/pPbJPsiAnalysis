...
void draw_compRatio_fit_hist(bool isPrompt = true, bool is1st = true, char* dirName = "draw_1D_vertex", char* dirName02 = "draw_compRatio_vertex", bool isNoError=true)
{
...
//	f02 = new TFile(Form("%s/1Dhist_EffCounting_8rap9pt2gev_%sembedded_%s_useCtErr_1_useDataDriven_0_useZvtxStep1_1_Step2_1.root",dirName,strPrompt,str1st));
	...
	/////////////////////// fit. vs hist.
	f01 = new TFile(Form("draw_1D_tnpCalo/1Dhist_EffCounting_8rap9pt2gev_%s_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root",sampleName));
	f02 = new TFile(Form("draw_1D_tnpHist/1Dhist_EffCounting_8rap9pt2gev_%s_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root",sampleName));
