...
void draw_1D_hist(bool isPrompt = true, bool is1st = true, bool isEmbedded = false, bool useCtErrRangeEff =true, bool useDataDrivenEff=true,  bool useZvtxWeightStep1 = false, bool useZvtxWeightStep2=true,char* dirName = "draw_1D_tnpV17")
{
  ...
  //gStyle->SetTitleSize(0.048,"xyz");
	...
	f2D = new TFile(Form("EffCounting_hist_8rap9pt2gev_%s_useCtErr_%d_useDataDriven_%d_useZvtxStep1_%d_Step2_%d.root",sampleName,(int)useCtErrRangeEff,(int)useDataDrivenEff,(int)useZvtxWeightStep1,(int)useZvtxWeightStep2));
