...
int rootAna_zVtxFit_step1(char *stringA = "20141218step1"){
...
//	TFile *f02 = new TFile("/home/songkyo/kyo/pPbDataSample/EfficiencySampleEmbedded/tot_PromptJpsi_HIJINGembedded_1st_STARTHI53_V27_20141123.root");
	TFile *f02 = new TFile("/home/songkyo/kyo/pPbDataSample/EfficiencySampleEmbedded/tot_PromptJpsi_HIJINGembedding_1st_STARTHI53_V27_20141218.root");
...
//	TString histTitle[] = {"mass (GeV/c^{2})", "p_{T} (GeV/c)", "y_{CM}", "#phi (rad)", "primary vertex Z (cm)"};
	...
	for (int i=0; i<nHist; i++) {
		...
		legU->AddEntry(h02[i],"MC_embedded","lp");
		legU->Draw();
