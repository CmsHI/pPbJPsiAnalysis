...
void draw_1D_data_mc_reco_pt(char* dirName = "8rap9pt2gev", bool isPrompt=true, bool isLog=false)
{
...
//	c_tot->SaveAs(Form("DataMcReco_%s/DataMcRecoPtRatio_tot_isPrompt%d_isLog%d.pdf",dirName,(int)isPrompt,(int)isLog));
	...
	c_Pbp2->SaveAs(Form("DataMcReco_%s/DataMcRecoPt_gRatio_Pbp_isPrompt%d.pdf",dirName,(int)isPrompt));
	...
	c_pPb2->SaveAs(Form("DataMcReco_%s/DataMcRecoPt_gRatio_pPb_isPrompt%d.pdf",dirName,(int)isPrompt));
	...
	c_tot2->SaveAs(Form("DataMcReco_%s/DataMcRecoPt_gRatio_tot_isPrompt%d.pdf",dirName,(int)isPrompt));
