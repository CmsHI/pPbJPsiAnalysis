...
int draw_closure_differential_jaebeom(int isPA=1, bool useZvtxWeight=false, bool useSF = false, bool isLog = false)
{
  gROOT->Macro("../Style.C");
  using namespace std;
  ...
  c_ratio_all->SaveAs(Form("dir_closure/%s_RECOGen_Ratio_all.pdf",wString.Data()));
