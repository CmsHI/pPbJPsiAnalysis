...
int rootAna_efficiency_counting_weight_6rap3pt_bin3_kyo01(char *strBinning = "6rap3pt", bool isPrompt = true, bool is1st = true, bool isEmbedded = false, bool useCtErrRangeEff =true, bool useDataDrivenEff=true, bool useZvtxWeightStep1 = false, bool useZvtxWeightStep2=true){
...
*/
	...
	TCanvas* creco = new TCanvas("creco","",600,600);
	creco->cd();
	func_0->Draw();
	/*
	TCanvas* creco = new TCanvas("creco","",1200,600);
	creco->Divide(4,2);
	creco->cd(1);
	func_0->Draw();
	creco->cd(2);
...
///////////////////////////////////
	...
	// --- save as a root file
	TFile *outFile = new TFile(Form("EffCounting_%s_useCtErr_%d_useDataDriven_%d_useZvtxStep1_%d_Step2_%d_bin3_kyo01.root",strName, (int)useCtErrRangeEff ,(int)useDataDrivenEff, (int)useZvtxWeightStep1, (int)useZvtxWeightStep2),"RECREATE");
	std::cout << "strName: " << strName << std::endl;
	outFile->cd();
