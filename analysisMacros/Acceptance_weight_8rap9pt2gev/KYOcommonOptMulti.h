...
void SetHistStyle(TH1* h, Int_t c, Int_t m) {
	...
	Int_t colorArr[] = { kGray+3, kRed+2, kBlue+1, kOrange+7, kOrange, kAzure+9, kViolet-4, kGreen+1,kBlack }; //tmp
...
//	Int_t markerOpenArr[] = {kOpenCircle, kOpenTriangleUp, kOpenTriangleDown, kOpenSquare, kOpenStar, kOpenDiamond};
	Int_t markerOpenArr[] = {kOpenCircle, kOpenTriangleUp, kOpenTriangleDown, kOpenSquare, kOpenCircle, kOpenTriangleUp, kOpenTriangleDown, kOpenSquare}; //tmp
