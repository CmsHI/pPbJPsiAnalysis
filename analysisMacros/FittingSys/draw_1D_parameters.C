...
void draw_1D_parameters(TString szBinning="8rap9pt", int isPA=1, bool isPrompt=true, bool isLog=false, TString szParam="coefExp")
{
  ...
  else if (strcmp(szParam,"coefPol")==0) {binmin=-0.28; binmax=-0.15;}
  ...
  else if (strcmp(szParam,"enne")==0) {binmin=0.; binmax=6.5;}
...
//  else if (strcmp(szParam,"meanPRResW")==0) {binmin=-0.5; binmax=0.5;} //need to be tuned..
  ...
  //// array TString
	...
	TFile * f2D_01 = new TFile(Form("../FittingSys/fitResHist_%s_%s_newcut_sys02_01_etOpt0.root",szBinning.Data(),szPA.Data()));
