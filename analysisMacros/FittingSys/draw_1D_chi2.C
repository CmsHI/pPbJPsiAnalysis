...
void draw_1D_chi2(TString szBinning="8rap9pt", int isPA=1, bool isPrompt=true, bool isLog=false, bool isNoErr=true, TString szParam="coefExp")
{
  ...
  if (strcmp(szParam,"UnNormChi2_mass")==0) {binmin=-3.0; binmax=200.0;}
  else if (strcmp(szParam,"nFitParam_mass")==0) {binmin=7.0; binmax=12.0;}
  else if (strcmp(szParam,"nFullBinsPull_mass")==0) {binmin=7.0; binmax=100.0;}
  else if (strcmp(szParam,"Dof_mass")==0) {binmin=0.0; binmax=100.0;}
  else if (strcmp(szParam,"Chi2_mass")==0) {binmin=0.0; binmax=5.0;}
  else if (strcmp(szParam,"theChi2Prob_mass")==0) {binmin=0.0; binmax=1.0;}
  else if (strcmp(szParam,"UnNormChi2_time")==0) {binmin=-3.0; binmax=200.0;}
  else if (strcmp(szParam,"nFitParam_time")==0) {binmin=7.0; binmax=12.0;}
  else if (strcmp(szParam,"nFullBinsPull_time")==0) {binmin=7.0; binmax=100.0;}
  else if (strcmp(szParam,"Dof_time")==0) {binmin=0.0; binmax=100.0;}
  else if (strcmp(szParam,"Chi2_time")==0) {binmin=0.0; binmax=5.0;}
  else if (strcmp(szParam,"theChi2Prob_time")==0) {binmin=0.0; binmax=1.0;}
  else if (strcmp(szParam,"UnNormChi2_side")==0) {binmin=-3.0; binmax=200.0;}
  else if (strcmp(szParam,"nFitParam_side")==0) {binmin=7.0; binmax=12.0;}
  else if (strcmp(szParam,"nFullBinsPull_side")==0) {binmin=7.0; binmax=100.0;}
  else if (strcmp(szParam,"Dof_side")==0) {binmin=0.0; binmax=100.0;}
  else if (strcmp(szParam,"Chi2_side")==0) {binmin=0.0; binmax=5.0;}
  else if (strcmp(szParam,"theChi2Prob_side")==0) {binmin=0.0; binmax=1.0;}
  ...
  //// array TString
	...
	TFile * f2D_01 = new TFile(Form("../FittingSys/fitResHist_%s_%s_newcut_sys01_04_etOpt0.root",szBinning.Data(),szPA.Data()));
...
//		}
	...
	c01->Modified();
	c01->Update();
	c01->SaveAs(Form("dir_1D_chi2/%s_%s_%s_wide.pdf",szPA.Data(),szBinning.Data(),szParam.Data()));
  ...
  for (Int_t iy = 0; iy < nbinsX; iy++) {
	...
	legUR->Draw();
	c02->SaveAs(Form("dir_1D_chi2/%s_%s_%s.pdf",szPA.Data(),szBinning.Data(),szParam.Data()));
