...
void draw_1D_acc_comp(TString szDir = "dir_acc_comp", bool isNoErr=false)
{
  ...
  TFile* f01 = new TFile("./dir_acc/8rap9pt_pp_PR_newcut_priv_AccPt.root");
  TFile* f02 = new TFile("./dir_acc/8rap9pt_pp_PR_newcut_priv_dimu_AccPt.root");
  TString szF01="ppPRpriv";
  TString szF02="ppPRprivdimu";
  double ratiomin=0.7; 
  double ratiomax=1.3; 
  //double ratiomin=0.; 
  //double ratiomax=1.2; 
