...
# with command line options: Configuration/GenProduction/python/HI/PYTHIA6_inclBtoPsiMuMu_5TeV02_nofilter_cff.py --fileout file:HIN-pAWinter13-inclBtoPsiMuMu_5TeV02_1st_nofilter.root --mc --eventcontent RAWSIM --pileup NoPileUp --datatier GEN --conditions STARTHI53_V27::All --beamspot Realistic5TeVPPbBoost --step GEN --datamix NODATAMIXER --python_filename HIN-pAWinter13-inclBtoPsiMuMu_5TeV02_1st_nofilter_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring,GeneratorInterface/HiGenCommon/customiseSwapVtxSmearAndProdFilter_cfi.customiseSwapVtxSmearAndProdFilter -n 100
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIN-pAWinter13-inclBtoPsiMuMu_5TeV02_1st_nofilter.root'),
