...
void compileSysUnc(){
  ...
  TFile *inf1 = new TFile("EffCounting_8rap9pt_PRMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
  TH2D* hNominal = (TH2D*)inf1->Get("h2D_Eff_pt_y");

  TFile *inf2 = new TFile("systematics/EffSys_SpectraVar_EffCounting_8rap9pt_PRMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
  ...
  TFile *inf3 = new TFile("systematics/EffSys_ZVtx_tnp_expo_PRMCpythia_Pbp_useCtErr_1_useDataDriven_V17_ZV_0_1_useZvtxStep1_0_Step2_1.root");
  ...
  TFile *infTnp = new TFile("systematics/EffSys_ZVtx_tnp_plo1_PRMCpythia_Pbp_useCtErr_1_useDataDriven_V17_ZV_1_1_useZvtxStep1_0_Step2_1.root");
