...
void rootAna_acceptance_fine(char *strBinnig = "8rap9pt", bool isPrompt=false){
...
//		ana1->Add("/home/songkyo/kyo/pPbDataSample/AcceptanceSampleKYOvtx/tot_GENonly_inclBtoJPsiMuMu_5TeV02_1st_KYOvtx_ntuple_20150127_p2.root");
  ...
  //Double_t yBinsArr[] = {-2.4, -1.97, -1.37, -0.47, 0.43, 1.03, 1.46}; // 6rap3pt
	...
	TH2D *h2D_NoCut_pt_y_Pbp = new TH2D("h2D_NoCut_pt_y_Pbp","",100,-2.5,2.5,100,0,30);
	TH2D *h2D_Den_pt_y_Pbp = new TH2D("h2D_Den_pt_y_Pbp","",100,-2.5,2.5,100,0,30);
	TH2D *h2D_Num_pt_y_Pbp = new TH2D("h2D_Num_pt_y_Pbp","",100,-2.5,2.5,100,0,30);
	TH2D *h2D_Acc_pt_y_Pbp = new TH2D("h2D_Acc_pt_y_Pbp","",100,-2.5,2.5,100,0,30);
...
/*
	...
	TFile *outFile = new TFile(Form("AccAna_%s_fine.root",strName),"RECREATE");
	std::cout << "strName: " << strName << std::endl;
	outFile->cd();
