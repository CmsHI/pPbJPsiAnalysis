...
void rootAna_acceptance_weighting(bool isPrompt=false, bool isPbp=false){
...
//    gROOT->Macro("rootlogon.C+");
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // Outputs
    TFile* toyFile = new TFile(Form("ToyGaussian_isPrompt%d_%s.root",(int)isPrompt,runstring.c_str()));
    TH1D* hWeight[nYBins];
    TF1* Func[nYBins];
