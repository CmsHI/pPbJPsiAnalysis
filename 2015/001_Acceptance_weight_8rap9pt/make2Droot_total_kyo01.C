...
/////// main func. ///////
int make2Droot_total_kyo01(char *dirName = "8rap9pt", char *dateName = "no"){
  ...
  using namespace std;
	...
	// kyo01
	TFile *fAccPR = new TFile("./AccAna_isPrompt1_Pbp_kyo01.root");
	TFile *fAccNP = new TFile("./AccAna_isPrompt0_Pbp_kyo01.root");
...
//	TH2D* h2D_Acc_pt_y_NPMC_pPb = (TH2D*)fAccNP->Get("h2D_Acc_pt_y_pPb");
	TH2D* h2D_Acc_pt_y_PRMC_Pbp = (TH2D*)fAccPR->Get("h2D_Acc_weight_pt_y_Pbp");
	TH2D* h2D_Acc_pt_y_PRMC_pPb = (TH2D*)fAccPR->Get("h2D_Acc_weight_pt_y_pPb");
	TH2D* h2D_Acc_pt_y_NPMC_Pbp = (TH2D*)fAccNP->Get("h2D_Acc_weight_pt_y_Pbp");
	TH2D* h2D_Acc_pt_y_NPMC_pPb = (TH2D*)fAccNP->Get("h2D_Acc_weight_pt_y_pPb");
	...
	TH2D* h2D_Acc_Den_pt_y_PRMC_Pbp = (TH2D*)fAccPR->Get("h2D_Den_weight_pt_y_Pbp");
	TH2D* h2D_Acc_Den_pt_y_PRMC_pPb = (TH2D*)fAccPR->Get("h2D_Den_weight_pt_y_pPb");
	TH2D* h2D_Acc_Den_pt_y_NPMC_Pbp = (TH2D*)fAccNP->Get("h2D_Den_weight_pt_y_Pbp");
	TH2D* h2D_Acc_Den_pt_y_NPMC_pPb = (TH2D*)fAccNP->Get("h2D_Den_weight_pt_y_pPb");
	...
	TH2D* h2D_Acc_Num_pt_y_PRMC_Pbp = (TH2D*)fAccPR->Get("h2D_Num_weight_pt_y_Pbp");
	TH2D* h2D_Acc_Num_pt_y_PRMC_pPb = (TH2D*)fAccPR->Get("h2D_Num_weight_pt_y_pPb");
	TH2D* h2D_Acc_Num_pt_y_NPMC_Pbp = (TH2D*)fAccNP->Get("h2D_Num_weight_pt_y_Pbp");
	TH2D* h2D_Acc_Num_pt_y_NPMC_pPb = (TH2D*)fAccNP->Get("h2D_Num_weight_pt_y_pPb");
	...
	//with TNP
/*
	TFile *fEffPRPbp = new TFile("../002_Efficiency_zVtx_embedded/EffCounting_8rap10pt_PRMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
	TFile *fEffPRpPb = new TFile("../002_Efficiency_zVtx_embedded/EffCounting_8rap10pt_PRMCpythia_pPb_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
	TFile *fEffNPPbp = new TFile("../002_Efficiency_zVtx_embedded/EffCounting_8rap10pt_NPMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
	TFile *fEffNPpPb = new TFile("../002_Efficiency_zVtx_embedded/EffCounting_8rap10pt_NPMCpythia_pPb_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1.root");
*/
	// kyo01
	TFile *fEffPRPbp = new TFile("./EffCounting_8rap9pt_PRMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1_kyo01.root");
	TFile *fEffPRpPb = new TFile("./EffCounting_8rap9pt_PRMCpythia_pPb_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1_kyo01.root");
	TFile *fEffNPPbp = new TFile("./EffCounting_8rap9pt_NPMCpythia_Pbp_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1_kyo01.root");
	TFile *fEffNPpPb = new TFile("./EffCounting_8rap9pt_NPMCpythia_pPb_useCtErr_1_useDataDriven_1_useZvtxStep1_0_Step2_1_kyo01.root");
...
//	TFile* fFitpPb = new TFile("./2Dhist_fitRes_8rap10pt_pPb.root");
	//kyo01
	TFile* fFitPbp = new TFile("../000_fittingResult/2Dhist_fitRes_8rap9pt_Pbp.root");
	TFile* fFitpPb = new TFile("../000_fittingResult/2Dhist_fitRes_8rap9pt_pPb.root");
	...
	////////////////////////////////////////////////
	////// save as a root file
	TFile *outFile = new TFile(Form("total2Dhist_%s_kyo01.root",dirName),"RECREATE");
	std::cout << "dirName: " << dirName << std::endl;
	cout << "total2Dhist_"<<dirName<<"kyo01.root has been created :) " <<endl;	
