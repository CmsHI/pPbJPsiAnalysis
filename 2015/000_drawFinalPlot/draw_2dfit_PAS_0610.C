...
void draw_2dfit_PAS(bool isPbp=true, bool isMass=true){
...
//  gStyle->SetPadTopMargin(0.05);
  ...
  //gStyle->SetPadRightMargin(0.04);
	...
	if (isPbp && isMass) {
		f2D = new TFile("./2dfit_root_pas/Pbp_8rap9pt_20150106_rap-2.4--1.97_pT3.0-4.0_cent0.0-100.0_dPhi0.000-1.571_ntrk0.0-350.0_ET0.0-120.0_massfit_wopull.root");
		c1_n2 = (TCanvas*)f2D->Get("c1_n2");
	}
	else if (isPbp && isMass) {	
		f2D = new TFile("./2dfit_root_pas/Pbp_8rap9pt_20150106_rap-2.4--1.97_pT3.0-4.0_cent0.0-100.0_dPhi0.000-1.571_ntrk0.0-350.0_ET0.0-120.0_timefit_Log_wopull.root");
		c1_n2 = (TCanvas*)f2D->Get("c2b");
	}	
	else if (!isPbp && isMass) {
		f2D = new TFile("./2dfit_root_pas/pPb_8rap9pt_20150106_rap-0.43-0.47_pT14.0-30.0_cent0.0-100.0_dPhi0.000-1.571_ntrk0.0-350.0_ET0.0-120.0_massfit_wopull.root");
		c1_n2 = (TCanvas*)f2D->Get("c1_n2");
	}
	else {
		f2D = new TFile("./2dfit_root_pas/pPb_8rap9pt_20150106_rap-0.43-0.47_pT14.0-30.0_cent0.0-100.0_dPhi0.000-1.571_ntrk0.0-350.0_ET0.0-120.0_timefit_Log_wopull.root");
		c1_n2 = (TCanvas*)f2D->Get("c2b");
	}	
