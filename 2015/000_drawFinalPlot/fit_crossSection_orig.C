...
void fit_crossSection(Int_t runCode=0, char* dirName = "fitCrossRap",bool is3pnt = false)
{
...
//  gStyle->SetPadTopMargin(0.05);
  ...
  //gStyle->SetPadRightMargin(0.04);
	...
	TF1* g_pr_low_L= new TF1("g_pr_low_L", "gaus", -2.87, 0.);
	g_pr_low_L->SetRange(-2.87,0.);
	...
	TF1* g_pr_high_L= new TF1("g_pr_high_L", "gaus", -2.87, 0.);
	g_pr_high_L->SetRange(-2.87,0.);
  ...
  globtex->SetTextFont(42);
	...
	globtex->DrawLatex(0.59, 0.42, Form("(low p_{T} R) #sigma : %.1f #pm %.1f",gpar_pr_low_R[2], gparerr_pr_low_R[2]));
	globtex->DrawLatex(0.35, 0.42, Form("(low p_{T} L) #sigma : %.1f #pm %.1f",gpar_pr_low_L[2], gparerr_pr_low_L[2]));
	globtex->DrawLatex(0.59, 0.34, Form("(high p_{T} R) #sigma : %.1f #pm %.1f",gpar_pr_high_R[2], gparerr_pr_high_R[2]));
	globtex->DrawLatex(0.35, 0.34, Form("(high p_{T} L) #sigma : %.1f #pm %.1f",gpar_pr_high_L[2], gparerr_pr_high_L[2]));
	c_pr->Update();
	...
	TF1* g_np_low_L= new TF1("g_np_low_L", "gaus", -2.87, 0.);
	g_np_low_L->SetRange(-2.87,0.);
	...
	TF1* g_np_high_L= new TF1("g_np_high_L", "gaus", -2.87, 0.);
	g_np_high_L->SetRange(-2.87,0.);
	...
	globtex->SetTextSize(0.030);
	globtex->DrawLatex(0.59, 0.42, Form("(low p_{T} R) #sigma : %.1f #pm %.1f",gpar_np_low_R[2], gparerr_np_low_R[2]));
	globtex->DrawLatex(0.35, 0.42, Form("(low p_{T} L) #sigma : %.1f #pm %.1f",gpar_np_low_L[2], gparerr_np_low_L[2]));
	globtex->DrawLatex(0.59, 0.34, Form("(high p_{T} R) #sigma : %.1f #pm %.1f",gpar_np_high_R[2], gparerr_np_high_R[2]));
	globtex->DrawLatex(0.35, 0.34, Form("(high p_{T} L) #sigma : %.1f #pm %.1f",gpar_np_high_L[2], gparerr_np_high_L[2]));
