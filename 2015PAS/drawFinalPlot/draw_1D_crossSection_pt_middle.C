...
//	int iPos=11;//left corner
	...
	//const Double_t zvtxCor = 1.; //No for new
...
//	TLegend *legUR = new TLegend(0.52, 0.55, 0.86, 0.92); //upper left
  ...
  globtex->SetTextFont(42);
	...
	gCross_pr_sys[0]->GetXaxis()->CenterTitle(1);
...
//	legBL -> SetHeader("Prompt J/#psi");
	...
	gCross_pr_sys[3]->GetXaxis()->CenterTitle(1);
...
//	legBL -> SetHeader("Prompt J/#psi");
	...
	gCross_np_sys[0]->GetXaxis()->CenterTitle(1);
	...
	gCross_np_sys[3]->GetXaxis()->CenterTitle(1);
