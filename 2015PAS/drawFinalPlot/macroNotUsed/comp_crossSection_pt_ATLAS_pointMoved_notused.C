...
int comp_crossSection_pt_ATLAS_pointMoved(bool shifted=true, Int_t runCode=0, bool isScale =false, bool isLog=true, bool isPtCut = false)
{
...
//		latex->DrawLatex(0.89, 0.31, "Preliminary");
	...
	c_pr->Update();
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d_shifted_%d.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d_shifted_%d.png",(int)isLog,(int)isPtCut,(int)shifted));
	//c_pr->Clear();
...
//		latex->DrawLatex(0.89, 0.31, "Preliminary");
	...
	c_np->Update();
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d_shifted_%d.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d_shifted_%d.png",(int)isLog,(int)isPtCut,(int)shifted));
	legUR2->Clear();
	//c_np->Clear();
