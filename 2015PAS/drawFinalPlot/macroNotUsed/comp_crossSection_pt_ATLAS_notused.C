...
int comp_crossSection_pt_ATLAS(Int_t runCode=0, bool isScale =false, bool isLog=false, bool isPtCut = false)
{
...
//	SetGraphStyle(gCross_atlas_prBW,2,10);
	...
	*/
	...
	c_pr->Update();
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d.pdf",(int)isLog,(int)isPtCut));
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d.png",(int)isLog,(int)isPtCut));
	legUR1->Clear();
	//c_pr->Clear();
...
// 	latex->DrawLatex(0.56, 0.71, "");
	...
	*/
	c_np->Update();
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d.pdf",(int)isLog,(int)isPtCut));
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d.png",(int)isLog,(int)isPtCut));
	legUR2->Clear();
	//c_np->Clear();
