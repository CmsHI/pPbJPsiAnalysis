...
//	}	
	...
	c_pr->Update();
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d_shifted_%d_middle_xErr.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_pr->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_pr_isLog%d_%d_shifted_%d_middle_xErr.png",(int)isLog,(int)isPtCut,(int)shifted));
	//c_pr->Clear();
	legUL01->Clear();
	legBL01->Clear();
	legUC01->Clear();
...
//	}	
	...
	c_np->Update();
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d_shifted_%d_middle_xErr.pdf",(int)isLog,(int)isPtCut,(int)shifted));
	c_np->SaveAs(Form("compOtherExp/comp_crossSection_pt_ATLAS_np_isLog%d_%d_shifted_%d_middle_xErr.png",(int)isLog,(int)isPtCut,(int)shifted));
	legUL01->Clear();
	legBL01->Clear();
	legUC01->Clear();
	legUC02->Clear();
