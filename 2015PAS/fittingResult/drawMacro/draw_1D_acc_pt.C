...
void draw_1D_acc_pt(char* dirName = "8rap9pt2gev", bool isLog=false)
{
...
//	}
	...
	for (Int_t iy = 0; iy < nbinsX; iy++) {
		...
		//h1D_acc_PRMC_Pbp[iy]->GetYaxis()->SetTitle("B fraction");
...
//	c_multi->cd(10);//tmp
//	legBR->Draw();
	c_multi->SaveAs(Form("acc_%s/acc_pt_isLog%d.pdf",dirName,(int)isLog));
