...
void fitRatio_kyo01(bool isPrompt=true, bool isPbp=true, char* dirName="8rap9pt2gev"){
    ...
    //TFile* fin = new TFile(Form("../004_closure/DataMcReco_%s/DataMcRecoPt_isPrompt%d.root",dirName,(int)isPrompt));//in KNU  //KYO
    /TFile* fin = new TFile(Form("./DataMcReco_%s/DataMcRecoPt_isPrompt%d.root",dirName,(int)isPrompt));//in KNU  //KYO
    string runstring;
