...
void rootAna_acceptance_weight_6rap3pt_kyo01(bool isPrompt=false, bool isPbp=true){
...
//            else if(1.93<= dimu_y && dimu_y<2.40) {  yflag = 7;  ptThr=0.0; }
  ...
  ////////////////////////////////////////////////////////////////////////////
    ...
    TFile *outFile = new TFile(Form("AccAna_isPrompt%d_%s_6rap3pt_kyo01.root",(int)isPrompt,runstring.c_str()),"RECREATE");
