...
int comp_crossSection_pt_ATLAS_middle_xErr(bool shifted=false, Int_t runCode=0, bool isScale =false, bool isLog=false, bool isPtCut = false)
{
...
//	  legUR11 -> SetHeader("Prompt J/#psi");
	  ...
	  legUR11 -> AddEntry(gCross_atlas_prFW,"0 < y_{CM} < 1.94","lp");
...
//	  legUR22 -> SetHeader("Non-Prompt J/#psi");
	  ...
	  legUR22 -> AddEntry(gCross_atlas_npFW,"0 < y_{CM} < 1.94","lp");
