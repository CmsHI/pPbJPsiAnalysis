...
void rootAna_acceptance_cutG(char *strBinnig = "8rap9pt2gev", bool isPrompt=true){
...
//	Double_t ptBinsArr[] = {0.0, 3.0, 4.0, 5.0, 6.5, 7.5, 8.5, 10.0, 14.0, 30.0}; // 8rap9pt
  ...
  Double_t yBinsArr[] = {-2.4, -1.97, -1.37, -0.47, 0.43, 1.03, 1.46, 1.93, 2.4}; // 8rap9pt & 8rap10pt & 8rap9pt2gev
  //Double_t yBinsArr[] = {-2.4, -1.97, -1.37, -0.47, 0.43, 1.03, 1.46}; // 6rap3pt
	...
	TFile *outFile = new TFile(Form("AccAna_%s_cutG.root",strName),"RECREATE");
	std::cout << "strName: " << strName << std::endl;
	outFile->cd();
