...
TH1F* hTnpRateEtaBin1 = (TH1F*)fTnpRate->Get("h_eff_ratio_MuIdAndTrig_etaBin1");
TH1F* hTnpRateEtaBin2 = (TH1F*)fTnpRate->Get("h_eff_ratio_MuIdAndTrig_etaBin2");
TH1F* hTnpRateEtaBin3 = (TH1F*)fTnpRate->Get("h_eff_ratio_MuIdAndTrig_etaBin3");
TH1F* hTnpRateEtaBin4 = (TH1F*)fTnpRate->Get("h_eff_ratio_MuIdAndTrig_etaBin4");
TH1F* hTnpRateEtaBin5 = (TH1F*)fTnpRate->Get("h_eff_ratio_MuIdAndTrig_etaBin5");

/////// main func. ///////

int rootAna_efficiency_counting_hist(char *strBinning = "8rap9pt2gev", bool isPrompt = true, bool is1st = true, bool isEmbedded = false, bool useCtErrRangeEff =true, bool useDataDrivenEff=true, bool useZvtxWeightStep1 = false, bool useZvtxWeightStep2=true){
...
*/		
  ...
  mytree->SetBranchAddress("Gen_QQ_mumi_4mom", &Gen_QQ_mumi_4mom, &b_Gen_QQ_mumi_4mom);
	...
	// --- save as a root file
	TFile *outFile = new TFile(Form("EffCounting_hist_%s_useCtErr_%d_useDataDriven_%d_useZvtxStep1_%d_Step2_%d.root",strName, (int)useCtErrRangeEff ,(int)useDataDrivenEff, (int)useZvtxWeightStep1, (int)useZvtxWeightStep2),"RECREATE");
	std::cout << "strName: " << strName << std::endl;
	outFile->cd();
